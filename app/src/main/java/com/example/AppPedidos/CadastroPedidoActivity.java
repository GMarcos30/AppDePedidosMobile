...
public class CadastroPedidoActivity extends AppCompatActivity {
    ...
    private void getClientes() {
        listaClientes = DataManipulation.getInstance().getListaClientes();
    ...
    private void getProdutos() {
        listaProdutos = DataManipulation.getInstance().getListaProdutos();
    ...
    private void salvarPedido() {
        ...
        DataManipulation.getInstance().salvarPedido(pedido);
    ...
    private void atualizarListaProduto() {
        ArrayList<Pedido> lista = DataManipulation.getInstance().getListaPedidos();
        String texto = "";
